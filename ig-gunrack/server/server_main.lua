...
QBCore.Functions.CreateUseableItem('policegunrack', function(source, item)
     ...
     TriggerClientEvent('ig-gunrack:client:start_installing_gunrack', source)
end)


if Config.gunrack.use_keys_to_unlock_gunrack then
     QBCore.Functions.CreateUseableItem('gunrackkey', function(source, item)
          TriggerClientEvent('ig-gunrack:menu:open_rack_by_key', source)
     end)
     ...
     QBCore.Functions.CreateUseableItem('keycuttingmachine', function(source, item)
          ...
          TriggerClientEvent('ig-gunrack:client:cut_key', source)
     end)
     ...
     RegisterNetEvent('ig-gunrack:server:start_cut_key', function(plate)
          local src = source
          local Player = QBCore.Functions.GetPlayer(src)
          ...
          TriggerClientEvent('ig-gunrack:client:keycuttingmachine_animation', src, plate)
     end)

     --
     RegisterNetEvent('ig-gunrack:server:cut_key', function(plate)
          local src = source
          local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('ig-gunrack:server:create_gunrack', function(plate)
     local src = source
     local Player = QBCore.Functions.GetPlayer(src)
     ...
     TriggerClientEvent('ig-gunrack:client:open_gunrack', src, plate)
end)

RegisterNetEvent('ig-gunrack:server:open_gunrack', function(plate)
     local src = source
     local Player = QBCore.Functions.GetPlayer(src)
     if not Player then return end
     if not IsJobAllowed(Player.PlayerData.job.name) then
