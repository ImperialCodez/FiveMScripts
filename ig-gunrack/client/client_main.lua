...
local function installing_gunrack()
     ...
     QBCore.Functions.Progressbar("keep_gunrack_install", Lang:t('progressbar.installing_gun_rack'), duration, false,
          ...
          TriggerServerEvent('ig-gunrack:server:create_gunrack', plate)
     end)
end
...
RegisterNetEvent('ig-gunrack:client:start_installing_gunrack', function()
     installing_gunrack()
end)

RegisterNetEvent("ig-gunrack:client:open_gunrack", function(plate)
...
AddEventHandler("ig-gunrack:client:open_gunrack_menu", function()
     local player_ped = PlayerPedId()
     local veh = nil
     ...
     TriggerServerEvent('ig-gunrack:server:open_gunrack', plate)
end)
...
if Config.gunrack.use_keys_to_unlock_gunrack then
     ...
     RegisterNetEvent('ig-gunrack:client:cut_key', function()
          ...
          if inputData then
               ...
               TriggerServerEvent('ig-gunrack:server:start_cut_key', inputData.PLATE)
          end
     end)

     RegisterNetEvent('ig-gunrack:client:keycuttingmachine_animation', function(plate)
          QBCore.Functions.Progressbar("keep_gunrack_keycuttingmachine", Lang:t('progressbar.cutting_key'),
               ...
               TriggerServerEvent('ig-gunrack:server:cut_key', plate)
          end)
     end)
end
